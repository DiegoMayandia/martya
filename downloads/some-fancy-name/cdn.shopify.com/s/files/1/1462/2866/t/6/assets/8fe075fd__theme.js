    ...
    productVariantCallback: function(variant) {
      ...
      if (variant) {
        ...
        if (variant.available) {
          ...
          this.settings.selectors.$addToCartText.html("Agregar al carrito");
          ...
          this.settings.selectors.$addToCartText.html("Agotado");
        ...
        if (this.settings.showComparePrice == 'true' ) {
          if (variant.compare_at_price > variant.price) {
            ...
            customPriceFormat += ' <span class="visually-hidden"><span class="visually-hidden">Precio Regular</span> ' + a11yComparePrice + '</span>';
            customPriceFormat += ' <span class="visually-hidden"><span class="visually-hidden">OFERTA</span> ' + a11yPrice + '</span>';
          }
        }
        ...
        if ( variant.compare_at_price > variant.price ) {
          ...
          this.settings.selectors.$comparePrice.html("Te ahorras [$]".replace('[$]', priceSaving)).show();
        } else {
